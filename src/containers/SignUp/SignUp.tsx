            ...
            <div className='w-1/2 h-[900px]'>
                <div className='flex flex-col items-left justify-start ml-[60px] mt-[140px] w-[800px]'>
                    ...
                    <div className='flex h-[50px]'>
                        <button className='bg-[#3B5998] hover:bg-[#3B5998] text-white font-bold py-2.5 px-3.5 border border-blue-700 rounded'>FacekBook 註冊</button>
                        <p className='flex items-center justigy-start ml-[15px]'>或</p>
                    </div>
                    <div className='h-[40px]'>
                        <p className='text-xs mt-4'>繼續進行代表你同意<a href='https://www.youtube.com/watch?v=qPSWnnqb3u0&list=PLwEeD5wMgnxJzXBWlLHqbGfXWmwZoTUNX&index=91&ab_channel=JM%E5%94%B1R%26B%E7%9A%84%E9%82%A3%E5%80%8B' className='text-[#0249ba]'>服務條款。</a></p>
                    </div>
                    ...
                    <div className='flex flex-col h-[60px] mt-[5px]'>
                        <label htmlFor='email' className='text-[14px] mb-[5px] font-semibold'>信箱</label>
                        <input
                            type='email'
                            id='email' 
                            value={email}
                    ...
                    <div className='flex flex-col h-[60px] mt-[5px]'>
                        <label htmlFor='password'className='text-[14px] mb-[5px] font-semibold'>密碼 ( 至少六碼 )</label>
                        <input 
                            type='password'
                            id='password'
                            value={password}
                    ...
                    <div className='flex flex-col h-[60px] mt-[5px]'>
                        <label htmlFor='verifyPassword' className='text-[14px] mb-[5px] font-semibold'>確認密碼</label>
                        <input
                            type='password'
                            id='verifyPassword'
                            value={checkPassword}
                    ...
                    <div className='h-[60px] flex-col h-[60px]'>
                        <div className='mt-[20px] space-x-2'>
                            <input type='checkbox' value='remenber' />
                            <label htmlFor = 'remenber' className='text-[14px]'>記得我的帳號，下次自動登入</label>
                        </div>
                    </div>
                    <div>
                        <button className='bg-transparent hover:bg-[#30ba55] text-[#30ba55] font-semibold hover:text-white py-2 px-6 border border-[#30ba55] hover:border-transparent rounded'>註冊</button>
                    </div>
                    <div className='h-[30px]'>
                        <p className='text-xs mt-2'>繼續進行代表你同意<a href='https://www.youtube.com/watch?v=qPSWnnqb3u0&list=PLwEeD5wMgnxJzXBWlLHqbGfXWmwZoTUNX&index=91&ab_channel=JM%E5%94%B1R%26B%E7%9A%84%E9%82%A3%E5%80%8B' className='text-[#0249ba]'>服務條款。</a></p>
                    </div>
